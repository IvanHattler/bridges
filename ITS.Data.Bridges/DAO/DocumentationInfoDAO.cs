...
{
    public class DocumentationInfoDAO : AbstractNHibernateDAO<DocumentationInfo, long>, IDocumentationInfoDAO
    {
        /// <summary>
        /// Создает слой доступа к данным по объектам типа.
        /// </summary>
        /// <param name="sessionFactoryConfigPath">Путь к фабрике NHibernate.</param>
        public DocumentationInfoDAO(string sessionFactoryConfigPath)

...
namespace ITS.Core.Bridges.Domain.EnumStrings
{
	...
	/// </summary>
	public class SidewalkTypeStrings : ITS.Core.Bridges.Domain.Base.EnumStrings<SidewalkType>
	{
		/// <summary>
		...
		public override string GetFullName(SidewalkType enumElement)
		{
			switch(enumElement)
			{
		...
		public override SidewalkType GetElement(string name)
		{

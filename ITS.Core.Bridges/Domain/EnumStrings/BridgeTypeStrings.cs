...
namespace ITS.Core.Bridges.Domain.EnumStrings
{
	...
	/// </summary>
	public class BridgeTypeStrings : ITS.Core.Bridges.Domain.Base.EnumStrings<BridgeType>
	{
		/// <summary>
		/// Путепровод
		/// </summary>
		...
		public override string GetFullName(BridgeType enumElement)
		{
			switch(enumElement)
			{
		...
		public override BridgeType GetElement(string name)
		{

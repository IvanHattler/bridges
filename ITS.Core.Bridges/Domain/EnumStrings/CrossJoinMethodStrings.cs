...
namespace ITS.Core.Bridges.Domain.EnumStrings
{
	...
	/// </summary>
	public class CrossJoinMethodStrings : ITS.Core.Bridges.Domain.Base.EnumStrings<CrossJoinMethod>
	{
		/// <summary>
		/// Не объединены
		/// </summary>
		...
		public override string GetFullName(CrossJoinMethod enumElement)
		{
			switch(enumElement)
			{
		...
		public override CrossJoinMethod GetElement(string name)
		{
			if (name == StrNone)

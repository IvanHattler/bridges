...
namespace ITS.Core.Bridges.Domain.EnumStrings
{
	...
	/// </summary>
	public class ProtectionTypeStrings : ITS.Core.Bridges.Domain.Base.EnumStrings<ProtectionType>
	{
		/// <summary>
		/// Парапетное
		/// </summary>
		...
		public override string GetFullName(ProtectionType enumElement)
		{
			switch(enumElement)
			{
		...
		public override ProtectionType GetElement(string name)
		{
			if (name == StrParapet)

...
namespace ITS.Core.Bridges.Domain.EnumStrings
{
	...
	/// </summary>
	public class RailingsTypeStrings : ITS.Core.Bridges.Domain.Base.EnumStrings<RailingsType>
	{
		/// <summary>
		/// Перила отсутствуют
		/// </summary>
		...
		public override string GetFullName(RailingsType enumElement)
		{
			switch(enumElement)
			{
		...
		public override RailingsType GetElement(string name)
		{
			if (name == StrNone)

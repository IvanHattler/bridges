...
namespace ITS.Core.Bridges.Domain.EnumStrings
{
	...
	/// </summary>
	public class CoverTypeStrings : ITS.Core.Bridges.Domain.Base.EnumStrings<CoverType>
	{
		/// <summary>
		/// Асфальтобетон
		/// </summary>
		...
		public override string GetFullName(CoverType enumElement)
		{
			switch(enumElement)
			{
		...
		public override CoverType GetElement(string name)
		{
